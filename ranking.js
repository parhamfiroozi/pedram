...
const majorConfig = {
  "مهندسي برق": {
    weights: {
      "الکتریسیته ساکن": 0.20,
      "جریان الکتریکی": 0.25,
      "مغناطیس": 0.20,
      "القای الکترومغناطیسی": 0.15,
      "توابع نمایی و لگاریتمی": 0.10,
      "ریاضیات گسسته": 0.10
    },
    color: '#f1c40f'
  },
  "مهندسي پزشكي": {
    weights: {
      // مدارها و حسگرهای پزشکی
      "جریان الکتریکی": 0.20,
      "مغناطیس": 0.10,
      "القای الکترومغناطیسی": 0.10,
      // بیوشیمی و فیزیولوژی
      "مولکول‌ها در خدمت تندرستی": 0.20,
      "اسیدها و بازها": 0.15,
      "در پی غذای سالم": 0.10,
      // آمار و احتمال برای تحلیل داده‌های بالینی
      "آمار توصیفی": 0.10,
      "آمار استنباطی": 0.05
    },
    color: '#9b59b6'
  ...
  "مهندسي كامپيوتر": {
    weights: {
      "ماتریس و کاربردها": 0.25,
      "آشنایی با نظریه اعداد": 0.20,
      "ریاضیات گسسته": 0.20,
      "تابع": 0.15,
      "تبدیل‌های هندسی": 0.10,
      "آمار توصیفی": 0.10
    },
    color: '#3498db'
  },
  "مهندسي مكانيك": {
    weights: {
      "دینامیک": 0.30,
      "حرکت بر خط راست": 0.25,
      "مغناطیس": 0.10,
      "کار، انرژی و توان": 0.15,
      "توابع نمایی و لگاریتمی": 0.10,
      "ریاضیات گسسته": 0.10
    },
    color: '#e74c3c'
  ...
  "مهندسي معماري": {
    weights: {
      "ترسیم‌های هندسی و استدلال": 0.30,
      "تبدیل‌های هندسی": 0.20,
      "روابط طولی در مثلث": 0.20,
      "حد و پیوستگی": 0.15,
      "آمار توصیفی": 0.10,
      "تابع": 0.05
    },
  ...
  "مهندسي هوافضا": {
    weights: {
      "دینامیک": 0.30,
      "حرکت بر خط راست": 0.20,
      "توابع نمایی و لگاریتمی": 0.15,
      "مغناطیس": 0.10,
      "محاسبات برداری": 0.15,
      "ریاضیات گسسته": 0.10
    },
  ...
  "مهندسي و علم مواد": {
    weights: {
      "ویژگی‌های فیزیکی مواد": 0.25,
      "ماتریس و کاربردها": 0.20,
      "حد و پیوستگی": 0.15,
      "تابع": 0.15,
      "آمار توصیفی": 0.15,
      "آشنایی با نظریه اعداد": 0.10
    },
    color: '#bdc3c7'
  },
  "مهندسي شهرسازي": {
    weights: {
      ...
      "حد و پیوستگی": 0.15,
      "تابع": 0.10,
      "مجموعه، الگو و دنباله + مثلثات": 0.05
    },
    color: '#27ae60'
  },
  "فيزيك": {
    weights: {
      "الکتریسیته ساکن": 0.15,
      "جریان الکتریکی": 0.15,
      "مغناطیس": 0.20,
      "القای الکترومغناطیسی": 0.20,
      "دینامیک": 0.15,
      "حد و پیوستگی": 0.15
    },
    color: '#e67e22'
  ...
  "شيمي محض": {
    weights: {
      "مولکول‌ها در خدمت تندرستی": 0.30,
      "اسیدها و بازها": 0.30,
      "قدر هدایای زمینی": 0.20,
      "پوشاک، نیازی پایان‌ناپذیر": 0.20
    },
    color: '#6a040f'
  },
  "شيمي كاربردي": {
    weights: {
      "پوشاک، نیازی پایان‌ناپذیر": 0.20,
      "رسانایی الکتریکی": 0.20,
      "مولکول‌ها در خدمت تندرستی": 0.20,
      "در پی غذای سالم": 0.20,
      "اسیدها و بازها": 0.20
    },
    color: '#00b4d8'
  },
  "رياضيات و كاربردها": {
    weights: {
      "حد و پیوستگی": 0.25,
      "توابع نمایی و لگاریتمی": 0.20,
      "تابع": 0.20,
      "ریاضیات گسسته": 0.20,
      "تبدیل‌های هندسی": 0.15
    },
    color: '#4a4e69'
  },
  // رشته‌های مدیریت و بازرگانی
  "مديريت صنعتي": {
    weights: {
      "آمار توصیفی": 0.30,
      "آمار استنباطی": 0.30,
